...
published: true
image: "./assets_2/article_cover.png"
---
...
![Kubernetes Architecture](./assets_2/Kubernetes_Architecture.png)
...
![Enabling Kubernetes](./assets_2/enable%20kubernetes%20in%20docker.png)
...
![kubectl Installation](./assets_2/curl%20kubectl%20then%20certutil%20-hashfile%20then%20type%20kubectl.exe.sha256%20then%20kubectl%20version%20client%20either%20normal%20or%20using%20--output=yaml.png)

![Checking kubectl Version](./assets_2/checking%20kubectl%20version%20--client.png)
...
![Helm Version](./assets_2/helm%20version.png)
...
![Helm Repository Setup](./assets_2/helm%20repo%20add%20apache%20airflow,%20helm%20repo%20update,%20helm%20install%20airflow%20flow.png)
...
![Applying Dashboard Manifest](./assets_2/kubectl%20apply%20-f%20github%20repo%20of%20the%20dashboard.png)
...
```
![Applying Dashboard RBAC](./assets_2/adminuser.png)
![Applying Dashboard RBAC](./assets_2/kubectl%20apply%20-f%20dashboard%20clusterrole%20%20dashboard%20secret%20.yaml.png)
...
![kubectl Proxy](./assets_2/kubectl%20proxy%20to%20access%20the%20dashboard.png)
...
![kubernetes Dashboard Access ](./assets_2/access.png)
...
![Getting Admin Token](./assets_2/kubectl%20get%20admin-user.png)

Use the generated token to log in.

![Dashboard Overview](./assets_2/kubernetes%20dashboard%20overview.png)
...
![Kubernetes Benefits for Airflow](./assets_2/dep_k_enables.png)
...
![Airflow Installation](./assets_2/cli%20to%20install%20using%20helm%20install%20airflow%20--namespace%20airflow%20--create-namespace.png)
...
![Fernet Key Command](./assets_2/cmd%20line%20to%20get%20the%20fernet%20key.png)
...
![Helm Upgrade](./assets_2/helm%20upgrade%20install%20airflow%20using%20the%20values.yaml.png)
...
![Workload Status](./assets_2/workload%20status%20in%20kubernetes%20dashboard%20everything%20is%20in%20a%20success%20status.png)
...
![Port Forwarding](./assets_2/port%20forward%20to%208080%20airflow%20api%20server%20in%20our%20case%20because%20webserver%20didnt%20work.png)
...
![Deployment Workflow](./assets_2/deployment_workflow.png)
...
![DAG Success](./assets_2/hello_word%20dag%20success.png)

![DAG Success Detail](./assets_2/hello_word%20dag%20success%202.png)
